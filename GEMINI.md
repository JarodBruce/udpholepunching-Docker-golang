...
## プロジェクトの目的
UDP hole punchingを試すためにDockerで二つのpodを作成してください
ファイアーウォールはiptablesを使い再現してください
UDP hole punchingを行うコード自体はGolangを使用してください
最終的に
A,Bの二つのGolangを実行し
AからBに文字列を送信しその文字列が表示されたら
Goodjobになります。
中継サーバなどは一切設置しないでください
p2pなどの形が理想型です。
